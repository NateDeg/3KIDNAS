...
ccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      Type ParameterVector
        ...
        real,dimension(:),ALLOCATABLE :: ParamRange
        integer,dimension(:),ALLOCATABLE :: CyclicSwitch
...
c           This routine allocates the parameter vector
      ...
      ALLOCATE(PV%CyclicSwitch(0:PV%nParams-1))
      ALLOCATE(PV%ParamRange(0:PV%nParams-1))
      PV%Param=-1.
...
c           This routine deallocates the parameter vector
      ...
      DEALLOCATE(PV%CyclicSwitch)
      DEALLOCATE(PV%ParamRange)
