...
def FileNames():
    ...
    for i in range(nModels):
        if i ==0:
            ...
            ModelFolders[i]=ParentFolder+"WALLABY_J100342-270137_CorrectGuess_WithNoise/"
            Labels[i]="Fit"
            
            IniParamFiles[i]=ModelFolders[i]+"WALLABY_J100342-270137_CorrectGuess_WithNoise_IniEstimate_v1.txt"
            FirstPassFiles[i]=ModelFolders[i]+"WALLABY_J100342-270137_CorrectGuess_WithNoise_FirstModel_v1.txt"
            FinalFiles[i]=ModelFolders[i]+"WALLABY_J100342-270137_CorrectGuess_WithNoise_AvgModel_v1.txt"
            
        elif i ==2:
            ModelFolders[i]=ParentFolder+"WALLABY_J100342-270137_Model_PreAnalysisTrial_Nois/"
            Labels[i]="Fit"
            
            IniParamFiles[i]=ModelFolders[i]+"WALLABY_J100342-270137_Model_PreAnalysisTrial_Nois_IniEstimate_v1.txt"
            FirstPassFiles[i]=ModelFolders[i]+"WALLABY_J100342-270137_Model_PreAnalysisTrial_Nois_FirstModel_v1.txt"
            FinalFiles[i]=ModelFolders[i]+"WALLABY_J100342-270137_Model_PreAnalysisTrial_Nois_AvgModel_v1.txt"
...
def ModelParamComp(ModelsDict):
    ...
    PlotName="Wallaby_J100342_PreAnalysisGuess_NoisyMap.png"
